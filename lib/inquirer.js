    ...
    const options = [
      {
        ...
        choices: ["Favorite cryptos", "Currency", "Items per page", "Go back"],
      },
    ];
    ...
    const options = [
      {
        ...
        choices: ["Add new crypto", "Delete existing crypto", "Go back"],
      },
    ];
    return inquirer.prompt(options);
  },
    ...
    const options = [
      {
        ...
        choices: [
          ...
          "Show Market Data (Favorite cryptos)",
          "Show Historical Data (Favorite cryptos)",
          "Configuration",
          "Exit",
        ],
      },
